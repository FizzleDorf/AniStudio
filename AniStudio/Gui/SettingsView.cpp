...
void SettingsView::SaveStyleToFile(const ImGuiStyle &style, const std::string &filename) {
    json j;
...
void SettingsView::LoadStyleFromFile(ImGuiStyle &style, const std::string &filename) {
