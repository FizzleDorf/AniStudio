...
void Engine::Init() {
    ...
    auto ViewListManagerID = viewManager.CreateView();
    viewManager.AddView<ViewListManager>(ViewListManagerID, ViewListManager(entityManager, viewManager));
    ...
    viewManager.GetView<ViewListManager>(ViewListManagerID).Init();
