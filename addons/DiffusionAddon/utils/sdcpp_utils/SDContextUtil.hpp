        ...
        try {
            ...
            for (const auto& comp : metadata["components"]) {
                if (comp.contains("Checkpoint")) {
                    ...
                    else if (model.contains("modelName") && !model["modelName"].is_null() && fs)
                        modelPath = fs->GetPath("Checkpoint") + "/" + model["modelName"].get<std::string>();
                ...
                if (comp.contains("Vae")) {
                    ...
                    else if (vae.contains("modelName") && !vae["modelName"].is_null() && fs)
                        vaePath = fs->GetPath("Vae") + "/" + vae["modelName"].get<std::string>();
                ...
                if (comp.contains("ClipL")) {
                    ...
                    else if (clipL.contains("modelName") && !clipL["modelName"].is_null() && fs)
                        clipLPath = fs->GetPath("Encoder") + "/" + clipL["modelName"].get<std::string>();
                ...
                if (comp.contains("ClipG")) {
                    ...
                    else if (clipG.contains("modelName") && !clipG["modelName"].is_null() && fs)
                        clipGPath = fs->GetPath("Encoder") + "/" + clipG["modelName"].get<std::string>();
                ...
                if (comp.contains("ClipVision")) {
                    ...
                    else if (clipVision.contains("modelName") && !clipVision["modelName"].is_null() && fs)
                        clipVisionPath = fs->GetPath("Encoder") + "/" + clipVision["modelName"].get<std::string>();
                ...
                if (comp.contains("T5XXL")) {
                    ...
                    else if (t5xxl.contains("modelName") && !t5xxl["modelName"].is_null() && fs)
                        t5xxlPath = fs->GetPath("Encoder") + "/" + t5xxl["modelName"].get<std::string>();
                ...
                if (comp.contains("LLM")) {
                    ...
                    else if (llm.contains("modelName") && !llm["modelName"].is_null() && fs)
                        llmPath = fs->GetPath("Encoder") + "/" + llm["modelName"].get<std::string>();
                ...
                if (comp.contains("LLMVision")) {
                    ...
                    else if (llmVision.contains("modelName") && !llmVision["modelName"].is_null() && fs)
                        llmVisionPath = fs->GetPath("Encoder") + "/" + llmVision["modelName"].get<std::string>();
                ...
                if (comp.contains("DiffusionModel")) {
                    ...
                    else if (diffusion.contains("modelName") && !diffusion["modelName"].is_null() && fs)
                        diffusionModelPath = fs->GetPath("Unet") + "/" + diffusion["modelName"].get<std::string>();
                ...
                if (comp.contains("HighNoiseDiffusionModel")) {
                    ...
                    else if (highNoise.contains("modelName") && !highNoise["modelName"].is_null() && fs)
                        highNoiseModelPath = fs->GetPath("Unet") + "/" + highNoise["modelName"].get<std::string>();
                ...
                if (comp.contains("Taesd")) {
                    ...
                    else if (taesd.contains("modelName") && !taesd["modelName"].is_null() && fs)
                        taesdPath = fs->GetPath("Vae") + "/" + taesd["modelName"].get<std::string>();
                ...
                if (comp.contains("Controlnet")) {
                    ...
                    else if (controlnet.contains("modelName") && !controlnet["modelName"].is_null() && fs)
                        controlnetPath = fs->GetPath("ControlNet") + "/" + controlnet["modelName"].get<std::string>();
                ...
                if (comp.contains("PhotoMaker") || comp.contains("StackedIdEmbed")) {
                    ...
                    else if (pm.contains("modelName") && !pm["modelName"].is_null() && fs)
                        photoMakerPath = fs->GetPath("Embed") + "/" + pm["modelName"].get<std::string>();
